...
export interface ApiActivityActivity extends Schema.CollectionType {
  ...
  attributes: {
    ...
    hasRights: Attribute.Boolean;
    address: Attribute.String;
    lat: Attribute.Float;
    lng: Attribute.Float;
    reference: Attribute.String;
    ages: Attribute.Relation<
      'api::activity.activity',
      'oneToMany',
      'api::age.age'
    >;
    levels: Attribute.Relation<
      ...
      'api::level.level'
    >;
    additionalItems: Attribute.Text;
    activityType: Attribute.Enumeration<['Actividad', 'Clase']>;
    vacancies: Attribute.Integer;
    duration: Attribute.Integer;
    mainPictureIndex: Attribute.Integer;
    ...
    creator: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    includedWith: Attribute.Text;
    notAllowedFor: Attribute.Text;
    paymentMethod: Attribute.String;
    phonetopay: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiAgeAge extends Schema.CollectionType {
  collectionName: 'ages';
  info: {
    singularName: 'age';
    pluralName: 'ages';
  ...
  attributes: {
    name: Attribute.String;
    startAge: Attribute.Integer;
    endAge: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::age.age', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::age.age', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiBookingBooking extends Schema.CollectionType {
  ...
  attributes: {
    activity: Attribute.Relation<
      ...
      'api::activity.activity'
    >;
    schedulesSelected: Attribute.Relation<
      'api::booking.booking',
      'oneToMany',
      'api::schedule.schedule'
    >;
    level: Attribute.Relation<
      ...
      'api::level.level'
    >;
    age: Attribute.Relation<'api::booking.booking', 'oneToOne', 'api::age.age'>;
...
export interface ApiPricePrice extends Schema.CollectionType {
  ...
  attributes: {
    priceDefinition: Attribute.Integer;
    ...
    level: Attribute.Relation<
      ...
      'api::level.level'
    >;
    age: Attribute.Relation<'api::price.price', 'oneToOne', 'api::age.age'>;
    ...
    activity: Attribute.Relation<
      ...
      'api::activity.activity'
    >;
    pricePackage: Attribute.Relation<
      'api::price.price',
      'oneToOne',
      'api::package.package'
    >;
